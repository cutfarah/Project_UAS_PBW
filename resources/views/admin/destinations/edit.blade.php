...
<head>
    ...
    <title>Edit Destinasi - Destigo</title>
        ...
        <div class="form-container">
            <div class="page-header">
                ...
                <p class="page-description">
                    Perbarui informasi destinasi wisata, harga tiket, kuota, lokasi, deskripsi, atau gambar destinasi.
                </p>
            </div>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number"
                                   id="adult_price"
                                   name="adult_price"
                                   value="{{ old('adult_price', $destination->adult_price ?? $destination->price) }}"
                                   min="0"
                                   step="1"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number"
                                   id="child_price"
                                   name="child_price"
                                   value="{{ old('child_price', $destination->child_price ?? (($destination->price ?? 0) * 0.75)) }}"
                                   min="0"
                                   step="1"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number"
                                   id="quota"
                                   name="quota"
                                   value="{{ old('quota', $destination->quota) }}"
                                   min="0"
                                   step="1"
